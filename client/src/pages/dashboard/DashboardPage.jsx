...
function DashboardPage() {
  ...
  const [vaultType, setVaultType] =
    useState('PERSONAL');

  useEffect(() => {
    if (user?.role === 'ADMIN') {
      setVaultType('COMPANY');
    } else {
  ...
  const stats = [
    {
      ...
      subtext: 'Passwords in selected vault',
      ...
      <div className="w-full min-w-0 space-y-6">
        ...
        {!loading && !error && (
          <>
                ...
                <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm overflow-hidden min-w-0">
                  ...
                  <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500 mt-1">
                        Track added and deleted passwords
                      </p>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 min-w-0">
              ...
              {stats.map((item) => (
                ...
                >
                  ...
                  <h2
                    className={`text-4xl font-bold mt-3 ${item.valueClass}`}
                  >
                    {item.value}
                  </h2>
            ...
            <div className="bg-white border border-slate-200 rounded-3xl p-8 min-w-0">
              ...
              <div className="mb-6">
                ...
                <p className="text-slate-500 text-sm mt-1">
                  Latest passwords included in dashboard
                </p>
              </div>
